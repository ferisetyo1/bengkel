            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('transaksi/simpanbarang') ?>" method="POST">
                                    ...
                                    <tbody id="cart">
                                        ...
                                        ?>
                                            <tr id="rowcart<?= $time ?>">
                                                ...
                                                <td><?= $value->nama ?> </td>
                                                <td><input type='hidden' name='id[]' value='<?= $value->id_barang ?>'><input class='form-control' type='number' name='harga[]' value='<?= $value->harga_jual ?>'></td>
                ...
                success: function(json) {
                    ...
                    json.forEach(element => {
                        ...
                        $("#cart").append("<tr id='rowcart" + date.getTime() + "'>" +
                            ...
                            "<td>" + element.nama + "</td>" +
                            "<td><input type='hidden' name='id[]' value='" + element.id_barang + "'><input class='form-control' type='number' name='harga[]' value='" + element.harga + "'></td>" +
                            "<td><input class='form-control' type='number' name='jumlah[]' value='1'></td>" +
                            "<td><textarea class='form-control' name='keterangan[]'  cols='30' rows='1'></textarea></td>" +
                            "</tr>")
                    });
